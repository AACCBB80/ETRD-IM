...
if (AutoUpdate == "true") then
	...
	updateCheck = http.get("https://raw.githubusercontent.com/AACCBB80/ETRD-IM/main/UPD.ATE")
	while updateCheck:status() == "running" do
	end
	updateCheckOut, tmp = updateCheck:finish()
...
local cfg1 = Textbox:new(10, cfgY, 45, 16, DefaultRoom, "Default Room")
